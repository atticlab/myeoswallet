<template>
  <div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6">
        <chart-card :chart-data="emailsCampaignChart.data" color="#ef8156" chart-title="TOTAL SUBSCRIPTIONS IN LAST 7 DAYS">
      ...
      <div class="col-lg-4 col-sm-6">
        <chart-card :chart-data="activeCountriesChart.data" color="#fbc658" chart-title="Active Countries">
